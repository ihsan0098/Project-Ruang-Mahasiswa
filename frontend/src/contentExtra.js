export const extra = {
  id: {
    ...
    mod: {
      ...
      bookingsTitle: "Janji Temu Konseling",
      approve: "Setujui",
      reject: "Tolak",
    ...
    booking: {
      cta: "Jadwalkan Sesi Konseling",
      title: "Janji Temu Konseling",
      desc: "Isi formulir singkat ini — tim Project Ruang akan menghubungi Anda untuk mengatur sesi dengan psikolog atau konselor mitra.",
      urgent: "Hasil Anda menunjukkan ruang yang sunyi — sesi konseling sangat disarankan. Anda tidak harus menghadapinya sendirian.",
      namePh: "Nama Anda",
      contactPh: "WhatsApp / email yang bisa dihubungi",
      dateLabel: "Tanggal preferensi",
      timeLabel: "Waktu preferensi",
      times: ["Pagi", "Siang", "Sore", "Malam"],
      notePh: "Catatan tambahan (opsional)",
      submit: "Kirim Permohonan",
      sending: "Mengirim…",
      success: "Permohonan terkirim. Tim kami akan menghubungi Anda untuk konfirmasi jadwal.",
      error: "Gagal mengirim. Coba lagi.",
      invalid: "Nama dan kontak (min. 5 karakter) wajib diisi.",
    },
  },
  en: {
    ...
    mod: {
      ...
      bookingsTitle: "Counseling Appointments",
      approve: "Approve",
      reject: "Reject",
    ...
    booking: {
      cta: "Schedule a Counseling Session",
      title: "Counseling Appointment",
      desc: "Fill in this short form — the Project Ruang team will contact you to arrange a session with a partner psychologist or counselor.",
      urgent: "Your result shows a silent room — a counseling session is strongly recommended. You don't have to face this alone.",
      namePh: "Your name",
      contactPh: "Reachable WhatsApp / email",
      dateLabel: "Preferred date",
      timeLabel: "Preferred time",
      times: ["Morning", "Midday", "Afternoon", "Evening"],
      notePh: "Additional notes (optional)",
      submit: "Send Request",
      sending: "Sending…",
      success: "Request sent. Our team will contact you to confirm the schedule.",
      error: "Failed to send. Please try again.",
      invalid: "Name and contact (min. 5 characters) are required.",
    },
  },
};
